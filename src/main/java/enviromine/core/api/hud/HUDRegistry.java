...
public class HUDRegistry {
    ...
    public static void registerHudItem(HudItem hudItem) {
        ...
        {
            log.info("Rejecting " + hudItem.getUnLocolizedName() + " due to invalid ID.");
        }
    ...
    public static void resetAllDefaults() 
    {
        ...
        {
            if(huditem instanceof IRotate) ((IRotate)huditem).setRotated(false);
    ...
    public static void writeToNBT(NBTTagCompound nbt) 
    {
        ...
        for (Object hudItem_ : hudItemListActive) 
        {
            ...
            nbt.setBoolean(hudItem.getUnLocolizedName(), true);
        }
