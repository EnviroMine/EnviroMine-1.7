...
public class MineSegmentShaft extends MineSegment
{
	...
	public boolean build()
	{
		...
		if(hasFloor && ((getBlockID(2, 1, 0) == Block.fence.blockID && getBlockID(2, 1, -1) == 0) || getBlockID(2, 1, -1) == 0))
		{
		...
		if(hasFloor && ((getBlockID(0, 1, 2) == Block.fence.blockID && getBlockID(-1, 1, 2) == 0) || getBlockID(-1, 1, 2) == 0))
		{
		...
		if(hasFloor && ((getBlockID(2, 1, 4) == Block.fence.blockID && getBlockID(2, 1, 5) == 0) || getBlockID(2, 1, 5) == 0))
		{
		...
		if(hasFloor && ((getBlockID(4, 1, 2) == Block.fence.blockID && getBlockID(5, 1, 2) == 0) || getBlockID(5, 1, 2) == 0))
		{
		...
		this.fillArea(0, 0, 2, 0, 3, 2, Block.planks.blockID, 0);
		this.fillAndRotate(1, 0, 2, 1, 3, 2, Block.ladder.blockID, 5);
