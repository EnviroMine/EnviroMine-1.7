...
public class EM_Gui_Bars extends GuiScreen
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiButton(101, this.width / 2 - 75, this.height / 6 + 24 - 6, 150, 20, StatCollector.translateToLocal("options.enviromine.barPos.hydration") +": "+ UI_Settings.waterBarPos  ));
		this.buttonList.add(new GuiButton(102, this.width / 2 - 75, this.height / 6 + 48 - 6, 150, 20, StatCollector.translateToLocal("options.enviromine.barPos.temprature")  +": "+ UI_Settings.heatBarPos ));
		this.buttonList.add(new GuiButton(103, this.width / 2 - 75, this.height / 6 + 72 - 6, 150, 20, StatCollector.translateToLocal("options.enviromine.barPos.sanity")  +": "+ UI_Settings.sanityBarPos ));
		this.buttonList.add(new GuiButton(104, this.width / 2 - 75, this.height / 6 + 96 - 6, 150, 20, StatCollector.translateToLocal("options.enviromine.barPos.airQuality")  +": "+ UI_Settings.oxygenBarPos ));
